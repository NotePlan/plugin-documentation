...
<Callout
  ...
  title="NOTE"
  description={`
Note that the choices array could also be a variable name of a variable defined in the frontmatter of the note. If you want to use a variable, you need to pre-evaluate it using a templating tag in frontmatter.
  `}
/>
