...
const note = note.getNote('My Note')
const note = note.getNote('this is a test.md')
const note = note.getNote('20220529')
const note = note.getNote('2024-01-01')
```
...
> This is equivalent to calling `note.getNote()` with no arguments.
