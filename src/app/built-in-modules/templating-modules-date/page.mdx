...
| **Week of Year** (see note below) | `w`                  | 1 2 ... 52 53                                     | Week of year (locale specific, **not** using NotePlan's start of week)                                               |
|                   | `ww`                 | 01 02 ... 52 53                                   | Week of year, zero-padded (locale specific, **not** using NotePlan's start of week)                                  |
|                   | `wo`                 | 1st 2nd ... 52nd 53rd                             | Week of year with ordinal (locale specific, **not** using NotePlan's start of week)                                  |
