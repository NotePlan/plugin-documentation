...
| **Week of Year**  | `w`                  | 1 2 ... 52 53                                     | Week of year (locale specific)                                               |
...
- `-> result` - Returns the number of days until the target date. Returns 0 if the target date is in the past or if `targetDateString` is invalid.
