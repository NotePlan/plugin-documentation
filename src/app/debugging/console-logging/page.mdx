...
<Callout
  type="tip"
  title="Speed Up Debugging"
  description="For speed of debugging, skip AI error analysis by adding `disableAIErrorAnalysis: true` to the frontmatter of your template."
/>
