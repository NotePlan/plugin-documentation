...
- **Add event link?**: whether to add a nicely-formatted event link when creating an event from a time block.
...
[<img width="200px" alt="Buy Me A Coffee" src="https://www.buymeacoffee.com/assets/img/guidelines/download-assets-sm-2.svg"></img>](https://www.buymeacoffee.com/revjgc)

Thanks!

## History

See [CHANGELOG](/eventhelpers/changelog) for the plugin's history.
