...
1. [Install the Templating plugin](/getting-started/templating-installation)
2. [Learn the basic concepts](/getting-started/templating-terminology)
3. [Create your first template](/core-features/templating-anatomy)
4. [Explore built-in modules](/built-in-modules/templating-modules-date)
...
- [Basic Concepts](/getting-started/templating-terminology)
- [Common Use Cases](/getting-started/templating-miscellaneous)
...
- [Miscellaneous Module](/built-in-modules/templating-modules-miscellaneous)

### Advanced Features

- [Async Operations](/advanced-features/templating-examples-async)
- [Conditional Logic](/advanced-features/templating-examples-conditional)
- [Looping](/advanced-features/templating-examples-looping)
- [Frontmatter](/advanced-features/templating-examples-frontmatter)
...
- [Web Scraping](/examples-templates/templating-examples-web)
- [Prompt Interface](/examples-templates/templating-examples-prompt)
...
- [Plugin Integration](/developer-guide/templating-examples-js-weather)
- [Custom Modules](/developer-guide/templating-examples-web)
- [Best Practices](/developer-guide/templating-examples-prompt)
- [Troubleshooting](/developer-guide/templating-examples-datetime)
