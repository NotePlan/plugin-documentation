import dashboard060 from '@/app/jgclark.Dashboard/Dashboard-0.6.0@2x.png'
import completecancel from '@/app/jgclark.Dashboard/complete+cancel.gif'
import actionbuttons from '@/app/jgclark.Dashboard/action-buttons-0.7.3@2x.png'

# 🎛 Dashboard plugin
{/* ![](Dashboard-0.6.0@2x.png) */}
<img src={dashboard060.src} alt="Dashboard window" width="650px"/>
...
{/* <img width="400px" src="complete+cancel.gif" border="1pt solid" margin="8px" align="right" /> */}
<img src={completecancel.src} width="400px" border="1pt solid" margin="8px" align="right" alt="example of Complete and Cancel"/>
...
{/* <img src="action-buttons-0.7.3@2x.png" width="330px" border="1pt solid" margin="8px" align="right" /> */}
<img src={actionbuttons.src} width="330px" border="1pt solid" margin="8px" alt="action buttons" />
...
- there's a UI toggle "Filter out lower-priority items?". If this is on, then items without any extra priority in calendar files will be hidden until there are no remaining priority items that haven't been completed. Priority items are indicated by having `>>`, `!!!`, `!!` or `!` at the beginning or end of the item.
...
## History
This documentation was last updated for v0.7.3.
