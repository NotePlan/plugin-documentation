...
import movebuttons from '@/app/jgclark.Dashboard/move-buttons@2x.png'
...
<img src={movebuttons.src} width="330px" border="1pt solid" margin="8px" align="right" alt="Move buttons" />
