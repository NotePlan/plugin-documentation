import georgecvideo2thumbnail from '@/app/jgclark.Reviews/georgec-video2-thumbnail.jpg'
import reviewlistrich from '@/app/jgclark.Reviews/review-list-rich-0.11@2x.png'
import projectflowchartbordered from '@/app/jgclark.Reviews/project-flowchart_bordered.jpg'
import reviewlistbuttons from '@/app/jgclark.Reviews/review-list-buttons-0.12.png'
import reviewlistmarkdown from '@/app/jgclark.Reviews/review-list-markdown-0.11@2x.png'

ta# 🔬 Projects + Reviews plugin
...
<img src={reviewlistrich.src} alt="Project Lists: example in 'Rich' style" width="650px" />
...
[<img src={georgecvideo2thumbnail.src} alt="video thumbnail" width="500px" />](https://youtu.be/R-3qn6wdDLk)

## Using NotePlan for Project-like work
Each **Project** is described by a separate note, and has a lifecycle something like this:

<img src={projectflowchartbordered.src} alt="project lifecycle" width="650px" />
...
<img src={reviewlistmarkdown.src} alt="Example of 'Markdown' style of Project Lists" width="650px" />
...
<img src={reviewlistbuttons.src} alt="Buttons in 'Rich' style" width="600px" />
