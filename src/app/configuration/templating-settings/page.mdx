...
<Callout
  type="info"
  title="WEATHER TAGS"
  description={`For more detailed information on supported weather tags refer to the <a href="/built-in-modules/templating-modules-web" alt="weather example">weather examples</a>.`}
/>
