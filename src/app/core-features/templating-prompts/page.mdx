...
```markdown
Project start date: <%- promptDate('startDate','Enter start date:') %>
Project start date: <%- promptDate('startDate','Enter start date:', '2024-01-01') %> // including default value
Project start date: <%- promptDate('startDate','Enter start date:', '', true) %> // no default value and allowing empty value
