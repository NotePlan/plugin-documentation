...
-> `openTasks` - Returns count of open tasks in the current note
...
```javascript
<%- note.openTasks() %> // returns number of open tasks (e.g., 5)
```
...
-> `completedTasks` - Returns count of completed tasks in the current note
...
```javascript
<%- note.completedTasks() %> // returns number of completed tasks (e.g., 3)
```
...
-> `openChecklists` - Returns count of open checklists in the current note
...
```javascript
<%- note.openChecklists() %> // returns number of open checklists (e.g., 2)
```
...
-> `completedChecklists` - Returns count of completed checklists in the current note
...
```javascript
<%- note.completedChecklists() %> // returns number of completed checklists (e.g., 1)
```
