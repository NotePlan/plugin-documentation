...
When the Template Runner template is running, the `getNoteTitled` frontmatter attribute tells Template Runner what document you want to write to (either silently or in focus in NotePlan).
