...
Here's the very basic TemplateRunner template (note that the properties in the frontmatter between the `---` and `---` below would be edited in the properties editor in NotePlan):
~~~markdown
---
