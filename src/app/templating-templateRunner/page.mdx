...
<Callout type="info">
Template Runner is a hidden command to be run from a callback URL. It is not a command that you can call from the Command Bar.
</Callout>
...
<Code
  language="text"
  code={`noteplan://x-callback-url/runPlugin?pluginID=np.Templating&command=templateRunner&arg0=Daily%20Note%20%28Simple%29&arg1=true`}
/>
