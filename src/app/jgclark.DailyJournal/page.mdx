import calendarnotes from '@/app/jgclark.DailyJournal/calendar-notes@2x.jpg'
...
<img src={calendarnotes.src} width="500px" alt="Sidebar showing time periods" />
...
These commands require the separate [Templating plugin](https://github.com/NotePlan/plugins/tree/main/Templating/) to be installed.
