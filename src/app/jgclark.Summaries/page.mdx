import ipu2wwithsparkline from '@/app/jgclark.Summaries/ipu-2w-with-sparkline.jpg'
import heatmaptasks0164 from '@/app/jgclark.Summaries/heatmap-tasks-0164.png'
import heatmapwork0164 from '@/app/jgclark.Summaries/heatmap-work-0164.png'
import ps202208withsparkline from '@/app/jgclark.Summaries/ps-202208-with-sparkline.png'
import timeperiodselection from '@/app/jgclark.Summaries/time-period-selection.png'
import calendarnotes from '@/app/jgclark.Summaries/calendar-notes@2x.jpg'

# ⏱ Habits and Summaries plugin

This Plugin lets you do the following sorts of things:
- track habits: for example, show when this week I've managed to `#readbook` or `#fast`?

  <img alt="Habit Tracker example" src={ipu2wwithsparkline.src} width="360px" />
...
- show a heatmap chart of your `@sleep` stats
  ...
  <img alt="Heatmap example for 'work'" src={heatmapwork0164.src} width="550px" />

- show a heatmap chart of how many tasks you've completed recently

  <img alt="Heatmap example for 'tasks'" src={heatmaptasks0164.src} width="550px" />
...
Note: if you specifiy any of the settings that take hashtags or mentions, then _only those ones will be used_. E.g. `{... "progressYesNo":"#read,#pray,#exercise", ...}` will not use any of the usual '#hashtags or count' or '@mentions to count', but _only_ show Yes/No for each of those 3 tags.
...
Note: Any string-based value part must be enclosed in **double quote marks** to make it valid JSON.
...
<img src={ps202208withsparkline.src} alt="periodStats with sparkline" />
...
<img src={timeperiodselection.src} alt="time period selection" />

It asks where to save its output: to a specially-created note in the Summaries folder, or to the current note.

<img alt="Calendar Notes types" src={calendarnotes.src} width="260px" align="right" />It also offers to write to the current Weekly / Monthly / Quarterly / Yearly notes if you have them enabled in the preferences.
...
## Support
If you find an issue with this plugin, or would like to suggest new features for it, please [raise an Issue or Feature here](https://github.com/NotePlan/plugins/issues).
