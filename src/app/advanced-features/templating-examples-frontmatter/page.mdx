...
## Expanding tags in the note's frontmatter header
...
_In the following examples we omit the template frontmatter between `---` for brevity._
...
```markdown
modified: _2021-12-31 10:36 AM_
```
