...
The two dashes `--` and the properties that follow must be at the very top (the first line) of the template. No other text or code can be placed above the two dashes or it will not be interpreted as frontmatter/properties, it will just be part of the note's content.
</Callout>
