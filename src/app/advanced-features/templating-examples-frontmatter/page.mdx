...
There is no right or wrong place to put the prompts, but it is often easier to put them in the main template's frontmatter and access them later **by variablename** where they are needed.
