import habitTrackerExample from '@/app/summaries/ipu-2w-with-sparkline.jpg'
import heatmapWorkExample from '@/app/summaries/heatmap-work-0164.png'
import heatmapTasksExample from '@/app/summaries/heatmap-tasks-0164.png'
import habitTrackerSparklineV2 from '@/app/summaries/ipu-2w-with-sparkline-v2.jpg'
import periodStatsSparkline from '@/app/summaries/ps-202208-with-sparkline.png'
import calendarNotesTypes from '@/app/summaries/calendar-notes@2x.jpg'
import timePeriodSelection from '@/app/summaries/time-period-selection.png'
...
- show a heatmap chart of your `@sleep` stats
  ...
  <img alt="Heatmap example" src={heatmapWorkExample.src} />

- show a heatmap chart of how many tasks you've completed recently

  <img alt="Heatmap example" src={heatmapTasksExample.src} />
...
<img
  alt="Habit Tracker example"
  src={habitTrackerSparklineV2.src}
  width="360px"
/>
...
<img alt="periodStats with sparkline" src={periodStatsSparkline.src} />
...
<img alt="time period selection" src={timePeriodSelection.src} />

It asks where to save its output: to a specially-created note in the Summaries folder, or to the current note.

<img
  alt="Calendar Notes types"
  src={calendarNotesTypes.src}
  width="500px"
  align="right"
/>
It also offers to write to the current Weekly / Monthly / Quarterly / Yearly notes
if you have them enabled in the preferences.
