...
When using any of the following <code>np.Templating</code> commands (<code>np:new</code>, <code>np:qtn</code>), the created note will use the <code>newNoteTitle</code> internally
  `}
/>
