...
`Templating` supports four types of prompts, with no configuration required.

By default, `Templating` will present a prompt consecutively as it processes the template for any missing variable contained in your template.
