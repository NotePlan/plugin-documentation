...
<Callout
  type="info"
  description={`
If you are installing <code>np.Templating</code> for the first time, this migration will happen automatically when <code>np.Templating</code> plugin is installed.
  `}
/>
