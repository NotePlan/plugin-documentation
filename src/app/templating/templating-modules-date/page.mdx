...
<Callout
  type="info"
  description={
    `Refer to the <a href="./templating-modules-time" alt="Time Module"> Time Module </a> page for similar methods which work with with time values. `
  }
/>
...
```javascript
<%- date.add('2022-01-07', 7) %> // returns 2022-01-14
```
...
```javascript
<%- date.subtract('2022-01-12', 7) %> // returns 2022-01-05
```
...
```javascript
<%- date.businessSubtract('2022-01-12', 3) %> // returns 2022-01-07
```
