...
<Callout
  ...
  title="WEATHER TAGS"
  description={
    `For more detailed information on supported weather tags <img src=` +
    noteplanpluginsettings.src +
    `  alt='Noteplan Plugin Settings' /> refer to [weather examples](/docs/templating-modules/web-module/#weather).`
  }
/>
...
<Callout
  type="info"
  title="WEB MODULE"
  description="For more information about using web services, refer to [Web Module](/docs/templating-modules/web-module)"
/>
