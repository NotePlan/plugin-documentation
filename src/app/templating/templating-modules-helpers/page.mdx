...
<Callout
  type="info"
  description={`
When using <code>np.Templating</code> in NotePlan Plugins, you should use the approach described in <a href="templating-integration-method">Example 3 - Custom Methods</a>.
`}
/>
