...
| 14    | Displays personal `Bible.votd` method (Bible Plugin , verse of the day) (See <Link href="templating-custom-plugins-overview">Templating Custom Plugins Overview</Link> section for information on creating custom `Templating` Plugins)   |
