...
```
noteplan://x-callback-url/runPlugin?pluginID=Templating&command=templateRunner&arg0=Daily%20Note%20%28Simple%29&arg1=true
```
...
location: append
exampleSilent: noteplan://x-callback-url/runPlugin?pluginID=Templating&command=templateRunner&arg0=addFixIt&arg1=false&arg2=textVar%3Dsomething
---
* <%- textVar %> #fixit
```
...
location: append
exampleURL: noteplan://x-callback-url/runPlugin?pluginID=Templating&command=templateRunner&arg0=logWorkout&arg1=true&arg2=var1%3DVALUE1%3Bvar2%3DVALUE2
---
...
await DataStore.invokePluginCommandByName("templateRunner","Templating",["Meeting Notes",true,eventInfoString])
```
````
...
`noteplan://x-callback-url/runPlugin?pluginID=Templating&command=templateRunner&arg0=logWorkout&arg1=true&arg2=var1%3DVALUE1%3Bvar2%3DVALUE2`

Broken apart, here's what that is comprised of:

`noteplan://x-callback-url/runPlugin?pluginID=Templating&command=templateRunner`: This tells NotePlan to call the templateRunner command inside of the Templating plugin
`&`
