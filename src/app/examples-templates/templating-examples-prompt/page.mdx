...
This will prompt the user for the value of the `lastName` key, and will store that value in the placeholder/variable `lastName`, and in this example, use that value in the template output.
...
## Using prompts in frontmatter

You can use prompts in frontmatter/properties to set the value of a frontmatter key of the template as it is rendered.

```markdown
---
title: My Template with Prompt in Frontmatter
lastName: <%- prompt('lastName', 'What is your last name?') %>
---
User entered last name: <%- lastName %>
```

This will prompt the user for the value of the `lastName` key, and will store that value in the frontmatter of the template, and in this example, use that value in the template output.

<Callout>
Note that this stores the value in the frontmatter of the template, to be used in the template output. This does not affect the frontmatter of a note that is being rendered. If you want to set the frontmatter of a note that is being rendered, see [Creating Notes with Properties/Frontmatter](/advanced-features/templating-examples-frontmatter).
</Callout>
