import addlinklinedemo from '@/app/jgclark.Filer/add-link-line-demo-T2.gif'
import notelinkexample from '@/app/jgclark.Filer/note-link-example.gif'
import projectlogjordonview from '@/app/jgclark.Filer/project-log-jordon-view.jpg'
import CHANGELOG from '@/app/jgclark.Filer/CHANGELOG.mdx'
...
<img src={addlinklinedemo.src} alt="add sync demo" />
...
<img src={projectlogjordonview.src} width="550px" alt="project log overview" />
_(Thanks to @jord8on for the graphic which inspired this set of commands.)_

In practice running /copy note links command on a daily note can achieve this:
{/* ![note link demo using /copy note links command](note-link-example1.gif) */}
<img src={notelinkexample.src} alt="note link demo using /copy note links command" />
...
## History
{/* TODO: Please see the [CHANGELOG](jgclark.Filer/CHANGELOG.mdx). */}
TODO: Please see the <a href="./CHANGELOG.mdx">CHANGELOG</a>).
TODO: Please see the <a href="./jgclark.Filer/CHANGELOG.mdx">CHANGELOG</a>).
TODO: Please see the <a href="/jgclark.Filer/CHANGELOG.mdx">CHANGELOG</a>).
TODO: Please see the <a href="./CHANGELOG.mdx">CHANGELOG</a>).
{/* TODO: Please see the [CHANGELOG]({CHANGELOG.src}). */}
TODO: Please see the <a href={CHANGELOG.src}>CHANGELOG</a>.
